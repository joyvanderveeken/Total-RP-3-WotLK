...
|cffff9900При отключении модуля необходимо перегрузить интерфейс.]=], -- Needs review
		...
		CO_TOOLTIP_OOC_NAME = "Показывать префикс [OOC] в имени",
		CO_TOOLTIP_OOC_NAME_TT = "Отображает [OOC] перед именем персонажа в подсказке, когда у него статус OOC.",
...
|cffffff00ПКМ:|r Сбросить цвет]=], -- Needs review
		...
		REG_PLAYER_NOTES_EMPTY = "Нет заметок", -- Needs review
