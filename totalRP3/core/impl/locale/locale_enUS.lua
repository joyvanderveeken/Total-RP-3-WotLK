...
local LOCALE_EN = {
	...
	localeContent = {
		...
		REG_PLAYER_NOTES_EMPTY = "No notes",
...
These tools also allow you to insert |cffffff00images, icons or link to external web site|r.]],
		...
		CO_GENERAL_ELVUI_TOOLTIPS = "Enable ElvUI tooltips",
		CO_GENERAL_ELVUI_TOOLTIPS_TT = "Apply ElvUI's style to TotalRP3 tooltips. Requires ElvUI to be installed and loaded.",
		CO_GENERAL_NOTES_STYLE = "Use written notes style",
		CO_GENERAL_NOTES_STYLE_TT = "Enable written notes style with custom fonts and colors. When unchecked, the classic TRP3 notes style will be used.",
		...
		CO_REGISTER_NOTES = "Notes",
		CO_REGISTER_NOTES_STYLE = "Use written notes style",
		CO_REGISTER_NOTES_STYLE_TT = "Enable written notes style with custom fonts and colors. When unchecked, the classic TRP3 notes style will be used.",
...
|cff00ff00Reminder : You can open Total RP 3 using /trp3 switch main|r]],
		...
		CO_CHAT_MAIN_NAMING_4 = "Title + First name + last name",
		CO_CHAT_MAIN_COLOR = "Use custom colors for names",
		CO_CHAT_MAIN_EMOTE_COLOR = "Use class colors for names in emotes",
		CO_CHAT_MAIN_ICON = "Show character icons in chat",
		CO_CHAT_MAIN_ICON_SIZE = "Chat icon size",
		...
		CO_CHAT_MAIN_CHAT_USE = "Use chat detection",
		...
		CO_LOCATION_DISABLE_CROSSFACTION = "Disable cross-faction location",
		CO_LOCATION_DISABLE_CROSSFACTION_TT = "You will not respond to location request from other players on the opposing faction.",
		...
		CO_LOCATION_HIGH_STRATA = "High strata map markers",
		CO_LOCATION_HIGH_STRATA_TT = "Display map markers on a higher frame strata, making them appear above other UI elements. Enable this if map markers are being hidden behind other addons.",
