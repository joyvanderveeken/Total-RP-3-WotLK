...
These tools also allow you to insert |cffffff00images, icons or link to external web site|r.]],
		...
		CO_REGISTER_NOTES_HEADER = "Notes settings",
		CO_REGISTER_NOTES_STYLE = "Use a classic notes style",
		CO_REGISTER_NOTES_STYLE_TT = "Enable the classic notes style with standard font and colors. Disable to use the modern TRP3 style.",
